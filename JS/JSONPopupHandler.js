...
function mirageSmokeLoad(loc, data) {
    if (loc === "bench") {
        ...
        for (let i = 0; i < Object.keys(data.mirage[0].bench).length; i++) {
            result += "<div class='smokeBoxMap' id='smokeBoxMap' onclick='showPopup(&quot;smokePopup&quot;); hidePopup(&quot;mainPopup&quot;, false); getDataImg(&quot;bench&quot;, " + i + ")'><h3>" + data.mirage[0].bench[i].from + "<i class='fas fa-cloud fa-1x'></i></h3><h4></h4><img src='" + data.mirage[0].bench[i].img[1] + "'></img></div>";
        }
